...
- Trade feed uses a **Scandinavian Trust** aesthetic: breathable layouts, soft shadows, and warm off-white surfaces.
- Trade card shows: instrument, entry price, quantity, trade type (BUY/SELL), and calm P&L performance.
- P&L updates are purposeful and subtle — designed to reduce anxiety while maintaining real-time accuracy.
